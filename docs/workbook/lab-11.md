...
1. ត្រួតលទ្ធផលលើបន្សំពណ៌ពិត និងពណ៌សន្មត។ សម្រាប់ចង្កោមនីមួយៗ កំណត់ថាតើវាទំនងជាគម្របដីអ្វី។
2. ប្រើ **Zonal statistics** ឬចុចលើក្រឡាគំរូ ដើម្បីអានតម្លៃមធ្យមក្រុមរលកនៃចង្កោមនីមួយៗ ជាភស្តុតាងបន្ថែម។
3. **Reclassify** (Raster → Raster Calculator ឬ Reclassify by Table) ដើម្បីបញ្ចូលចង្កោមដែលតំណាងឲ្យគម្របដីតែមួយចូលគ្នា។ រក្សាទុកជា `landcover_unsupervised.tif`។
4. បង្កើតសញ្ញាសម្គាល់ផែនទីជាមួយឈ្មោះគម្របដីពិត (មិនមែន «ចង្កោម ១» ទៀតទេ)។
